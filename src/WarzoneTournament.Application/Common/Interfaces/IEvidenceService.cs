...
public interface IEvidenceService
{
    ...
    Task<Result<EvidenceDto>> ApproveWithVerifiedDataAsync(Guid evidenceId, string reviewedBy, int? placement, int? kills, string? notes, Dictionary<Guid, int>? playerKills = null, CancellationToken ct = default);
}
