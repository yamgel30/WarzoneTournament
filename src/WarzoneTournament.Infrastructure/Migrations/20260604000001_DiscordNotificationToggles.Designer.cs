...
namespace WarzoneTournament.Infrastructure.Migrations
{
    ...
    [Migration("20260604000001_DiscordNotificationToggles")]
    partial class DiscordNotificationToggles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WarzoneTournament.Domain.Entities.AppNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WarzoneTournament.Domain.Entities.PendingDiscordInvite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("InvitedDiscordId")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)");
                    ...
                    b.HasIndex("InvitedDiscordId");

                    b.HasIndex("TeamId", "InvitedDiscordId");

                    b.ToTable("PendingDiscordInvites", (string)null);
                });
            ...
            modelBuilder.Entity("WarzoneTournament.Domain.Entities.SiteSettings", b =>
                {
                    ...
                    b.Property<bool>("DiscordDmEvidenceApproved")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("DiscordDmEvidenceRejected")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("DiscordDmTeamInvitation")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("DiscordDmPendingInvite")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("DiscordAnnounceTournamentStart")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("DiscordAnnounceMatchResult")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);

                    b.Property<bool>("DiscordAnnounceNewRegistration")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("WarzoneTournament.Domain.Entities.Tournament", b =>
                {
                    ...
                    b.Property<int?>("MatchPointThreshold")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WarzoneTournament.Domain.Entities.AppNotification", b =>
                {
                    b.HasOne("WarzoneTournament.Domain.Entities.AppUser", "User")
                        .WithMany()
